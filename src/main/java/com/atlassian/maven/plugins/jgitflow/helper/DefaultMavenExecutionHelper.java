    ...
    public MavenSession reloadReactor(MavenProject rootProject, MavenSession oldSession) throws ReactorReloadException
    {
        ...
        try
        {
            while(!projectFiles.isEmpty())
            {
                ...
                MavenProject project = projectBuilder.build(file, oldSession.getLocalRepository(), new DefaultProfileManager(oldSession.getContainer(),oldSession.getSettings(),oldSession.getExecutionProperties()));
